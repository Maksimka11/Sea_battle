        ...
        if (this.playerTurn && mouse.left && !mouse.pLeft) {
          ...
          if (result) {
            ...
            if (shot.variant === "killed") {
              ...
              if (counter[0] != livedships[0]) stat.quadroCage += 1;else if (counter[1] != livedships[1]) stat.tripleCage += 1;else if (counter[2] != livedships[2]) stat.doubleCage += 1;else if (counter[3] != livedships[3]) stat.singleCage += 1;
              livedships = counter;
